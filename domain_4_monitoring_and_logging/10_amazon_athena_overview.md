...
- Use cases: Business Intelligene / analytics / reporting, analyze & query VPC flow logs, ELB logs, CloudTrail trals etc as long as they are in S3
...
- Use columnar data for cost-savings (less scan)
    ...
    - Huge performance
    - Use Glue (ETL) to convert your data to Parque or ORC (CSV -> Parquet)
