...
- you can create an account request Terraform file which trigers the AFT workflow for your acocunt provisioning

`EXAM`
- Offers built in featre options (disabled by default)
